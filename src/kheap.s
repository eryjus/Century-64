...
; to biggest.  In addition, when the OrderedList is searched for the "best fit" (that is the
...
;
; Finally, the dedicated OrderedList array is going to be eliminated in this
